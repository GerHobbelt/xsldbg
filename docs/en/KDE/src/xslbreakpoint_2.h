...
*/
    ...
    int addBreakPoint(const xmlChar * url, long int lineNumber,
...
*/
    ...
    xslBreakPointPtr getBreakPoint(const xmlChar * url, long int lineNumber);
...
*/
    ...
    int isBreakPoint(const xmlChar * url, long int lineNumber);
