...
typedef enum {
    ...
    XSLDBG_MSG_PROCESSING_RESULT,       /* 8: An error occurred performing command
                                         * requested command */
    ...
    XSLDBG_MSG_FILEOUT,         /* 14 : Response to cat command, ie
    ...
    XSLDBG_MSG_TEMPLATE_CHANGED,        /* 17 : Response to templates command
                                         * ie template details */
    ...
    XSLDBG_MSG_FIRST_LINE_REACHED    /* 27:  Reached first break point after starting */,
    XSLDBG_MSG_FIRST_TEMPLATE_REACHED    /* 28:  Reached first template break point reached after starting */
} XsldbgMessageEnum;
